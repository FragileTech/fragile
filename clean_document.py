...
def clean_document(input_path: Path) -> str:
    ...
    correction_pattern = r':::\{warning\} Correction from Dual Review\n(.*?)\n\nThe correct mechanism is (.*?)\n:::'
    ...
    content = re.sub(r'\(REVISED[^\)]*\)\s*', '', content)

    return content

if __name__ == '__main__':
    input_file = Path('/home/guillem/fragile/docs/source/1_euclidean_gas/11_hk_convergence_bounded_density_rigorous_proof.md')
