...
**Structure:** From Theorem {prf:ref}`thm-qsd-exchangeability` in [A1_qsd_exchangeability_theory.md](A1_qsd_exchangeability_theory.md), $\pi_N$ has:
...
**Answer:** From the conditional Gaussian structure (Lemma {prf:ref}`lem-conditional-gaussian-qsd` in [A1_qsd_exchangeability_theory.md](A1_qsd_exchangeability_theory.md)), velocities have **bounded variance** for each walker:
...
**QSD Structure:**
- [A1_qsd_exchangeability_theory.md](A1_qsd_exchangeability_theory.md) - Rigorous QSD theory (exchangeability, mean-field limit, N-uniform LSI)
