#!/usr/bin/env python3
"""Simple test script to verify spatial dimension configuration works correctly."""
...
def test_potential_well_config():
    ...
    print("=" * 80)
    print("Test 1: PotentialWellConfig dimension computation")
    print("=" * 80)
...
def test_baryon_channel_filtering():
    ...
    print("=" * 80)
    print("Test 2: Baryon channel filtering")
    print("=" * 80)
...
def test_voronoi_spatial_dims():
    ...
    print("=" * 80)
    print("Test 3: Voronoi tessellation with spatial_dims")
    print("=" * 80)
