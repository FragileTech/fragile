...
class VisitGrid {
 public:
  ...
  explicit VisitGrid(int32_t block_size = 5, float erase_coef = 0.05f, float clip_max = 1000.0f);
  ...
  void block_sums(const std::vector<VisitKey>& keys, std::vector<float>& out) const;
