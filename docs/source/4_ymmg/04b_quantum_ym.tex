...
=
\left\langle \overline{f^-},T_t g^+\right\rangle_{L^2(\pi_\infty)},
\]
...
=
\left\langle
\overline{\E_{\mathbb P}[F^-\mid\mcF_0]-\E_{\mathbb P}[F^-]},\,
...
=
\langle \overline{f_\Theta},T_t g\rangle_{L^2(\pi_\infty)}.
\]
\end{corollary}
