...
Our cluster-based proof establishes that $\kappa_W$ is built from components $f_{UH}(\varepsilon)$, $p_u(\varepsilon)$, $c_{\text{align}}(\varepsilon)$ that are **explicitly proven N-uniform** in [03_cloning](03_cloning). This validates the Fragile Gas as a scalable, physically meaningful model.
:::
...
2. ✅ **Leverages proven bounds**: All constants from [03_cloning](03_cloning) Chapters 6-8
