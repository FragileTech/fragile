...
$$
\mathcal{A}(\mathcal{S}) := \{i \in \{1,\ldots,N\} : s_i = 1\}
$$

 (alive set)

$$
\mathcal{D}(\mathcal{S}) := \{i \in \{1,\ldots,N\} : s_i = 0\}
$$
...
This section contains comprehensively documented mathematical results from the Fractal Set framework (`13_fractal_set_new/`), which views the Fragile Gas dynamics as a discrete spacetime structure emergent gauge symmetries, lattice QFT, and Riemannian geometry.

**Total Coverage:** 210 mathematical objects from 11 source documents

**Key Topics:**
- Discrete spacetime structure (CST nodes and edges, IG edges)
- Spinor representations and fermionic statistics
- Gauge theory: U(1)_fitness, SU(2)_weak, SU(3)_color, S_N permutation, SO(10) GUT
- Episode computational equivalence and QSD sampling
- Lattice quantum field theory formulation
- **Causal set theory**: Fractal Set as valid causal set, adaptive sprinkling, faithful discretization
- **Quantum gravity connections**: d'Alembertian, Ricci scalar, Einstein equations emergence
- Riemannian geometry: volumes, areas, integration, curvature
- Continuum limits and graph Laplacian convergence
- Stratonovich SDE and QSD foundations
- Noether currents and conserved charges
- Yang-Mills gauge theory with fundamental constants

**Source Documents:**
- [13_fractal_set_new/01_fractal_set.md](13_fractal_set_new/01_fractal_set.md) - Core data structure, nodes, edges, spinors, gauge symmetries
- [13_fractal_set_new/02_computational_equivalence.md](13_fractal_set_new/02_computational_equivalence.md) - Episode equivalence, BAOAB discretization, geometric ergodicity
- [13_fractal_set_new/03_yang_mills_noether.md](13_fractal_set_new/03_yang_mills_noether.md) - Yang-Mills gauge theory, Noether theorem, conserved currents, fundamental constants
- [13_fractal_set_new/04_rigorous_additions.md](13_fractal_set_new/04_rigorous_additions.md) - Graph Laplacian convergence, connection to Christoffel symbols, gauge curvature
- [13_fractal_set_new/05_qsd_stratonovich_foundations.md](13_fractal_set_new/05_qsd_stratonovich_foundations.md) - Stratonovich SDE, QSD marginal, Kramers-Smoluchowski reduction
- [13_fractal_set_new/06_continuum_limit_theory.md](13_fractal_set_new/06_continuum_limit_theory.md) - Continuum limits, annealed approximation, convergence rates
- [13_fractal_set_new/07_discrete_symmetries_gauge.md](13_fractal_set_new/07_discrete_symmetries_gauge.md) - Discrete symmetries, gauge transformations, equivariance
- [13_fractal_set_new/08_lattice_qft_framework.md](13_fractal_set_new/08_lattice_qft_framework.md) - Lattice QFT, fermionic exclusion, Wilson loops, gauge action
- [13_fractal_set_new/09_geometric_algorithms.md](13_fractal_set_new/09_geometric_algorithms.md) - Fan triangulation, empirical metrics, parallel transport
- [13_fractal_set_new/10_areas_volumes_integration.md](13_fractal_set_new/10_areas_volumes_integration.md) - Riemannian volumes, areas, integration, Cayley-Menger formula
- [13_fractal_set_new/11_causal_sets.md](13_fractal_set_new/11_causal_sets.md) - **Causal set theory foundations**: Fractal Set satisfies all CST axioms, adaptive sprinkling vs Poisson, faithful discretization, d'Alembertian convergence, Myrheim-Meyer dimension, Ricci scalar estimation, Einstein equations emergence, observable predictions
...
**Related Results:** `def-baoab-integrator`, `def-hybrid-sde`
...
**Related Results:** `def-baoab-integrator`, `ax:lipschitz-fields`, `prop-lipschitz-diffusion`
...
**Related Results:** `def-baoab-integrator`, `thm-continuous-drift-established`, `lem-baoab-error-bound`
...
**Related Results:** `thm-su2-interaction-symmetry`, `thm-sn-braid-holonomy`, `thm-u1-fitness-global`, `def-baoab-kernel`, `thm-sn-su2-lattice-qft`, `def-swarm-state-vector`, `def-cloning-amplitude-factorization`, `def-node-spacetime`, `thm-fractal-set-reconstruction`
...
**Related Results:** `lem-quantitative-keystone`, `thm-main-convergence`, `thm-discrete-drift-baoab`, `thm-ueph`, `thm-foster-lyapunov-main`, `thm-fractal-set-ergodicity`
...
**Related Results:** `thm-effective-planck-constant`, `thm-dimensionless-ratios`, `thm-u1-coupling-constant`, `thm-su2-coupling-constant`, `thm-mass-scales`, `def-parameter-dimensions`, `def-fine-structure-constant`, `thm-correlation-length`
...
**Related Results:** `def-discrete-ym-action`, `def-su2-gauge-field`
...
**Related Results:** `thm-qsd-spatial-marginal-detailed`, `thm-stratonovich-stationary-general`, `thm-stratonovich-kramers-smoluchowski`, `thm-graph-laplacian-convergence-consequence`

---

### Kramers-Smoluchowski Reduction for Position-Dependent Diffusion

**Type:** Theorem
**Label:** `thm-kramers-smoluchowski-full`
**Source:** [13_fractal_set_new/05_qsd_stratonovich_foundations.md § Appendix B: Kramers-Smoluchowski Reduction (Full Derivation)](13_fractal_set_new/05_qsd_stratonovich_foundations.md)
**Tags:** `fractal-set`
...
In the high-friction limit $\gamma \gg 1$, the spatial marginal density $\rho_s(x, t) := \int \rho(x, v, t) dv$ evolves according to the **spatial Fokker-Planck equation**:
...
**Related Results:** `thm-discrete-permutation-invariance-discrete-sym`, `cor-discrete-rotational-equivariance-discrete-sym`, `thm-discrete-translation-equivariance-discrete-sym`, `conj-connection-to-braid-holonomy-discrete-sym`
...
**Related Results:** `thm-discrete-permutation-invariance-discrete-sym`, `cor-discrete-rotational-equivariance-discrete-sym`, `thm-discrete-translation-equivariance-discrete-sym`, `prop-episode-count-conservation-discrete-sym`
...
**Related Results:** `alg-tetrahedral-volume`, `alg-fan-triangulation-area`, `alg-simplicial-decomposition`
...
## Quantitative Error Bounds and Convergence Rates

This section contains explicit convergence rate bounds with N-uniform constants for the discrete N-particle Fragile Gas algorithm converging to the continuous mean-field limit. The total error is O(1/√N + Δt) where the mean-field error dominates and the discretization error is negligible for large N.

### Wasserstein-Entropy Relationship

**Type:** Lemma
**Label:** `lem-wasserstein-entropy`
**Source:** [20_A_quantitative_error_bounds.md § Part I](20_A_quantitative_error_bounds.md)
**Tags:** `wasserstein`, `kl-divergence`, `lsi`, `talagrand`

**Statement:**
Under the N-uniform LSI with constant $\alpha_{\text{LSI}}$:

$$
W_2^2(\mu_N, \nu_0) \leq \frac{2}{\alpha_{\text{LSI}}} D_{\text{KL}}(\mu_N \| \nu_0)
$$

where $W_2$ is the 2-Wasserstein distance and $D_{\text{KL}}$ is the Kullback-Leibler divergence.

**Related Results:** `thm-quantitative-kl-bound`, Talagrand's transport-entropy inequality

---

### Quantitative KL-Divergence Bound

**Type:** Theorem
**Label:** `thm-quantitative-kl-bound`
**Source:** [20_A_quantitative_error_bounds.md § Part I](20_A_quantitative_error_bounds.md)
**Tags:** `kl-convergence`, `mean-field`, `interaction-complexity`, `fournier-guillin`

**Statement:**
For the N-particle QSD $\nu_N$ and mean-field limit $\rho_0$:

$$
D_{\text{KL}}(\nu_N \| \rho_0^{\otimes N}) \leq \frac{C_{\text{int}}}{N}
$$

where $C_{\text{int}}$ is the interaction complexity constant bounded in terms of Lipschitz constants of mean-field drift and diffusion.

**Related Results:** `lem-interaction-complexity`, `thm-quantitative-propagation-chaos`

---

### Interaction Complexity Constant

**Type:** Lemma
**Label:** `lem-interaction-complexity`
**Source:** [20_A_quantitative_error_bounds.md § Part I](20_A_quantitative_error_bounds.md)
**Tags:** `interaction-complexity`, `lipschitz`, `mean-field-drift`, `regularity`

**Statement:**
The interaction complexity constant is bounded by:

$$
C_{\text{int}} \leq C_0 \left( L_b^2 + L_{\sigma}^2 + \frac{L_b^2}{\alpha_{\text{LSI}}} \right)
$$

where:
- $L_b$ = Lipschitz constant of mean-field drift $b(\cdot, \rho)$ in $(x, \rho)$
- $L_{\sigma}$ = Lipschitz constant of diffusion coefficient
- $\alpha_{\text{LSI}}$ = LSI constant
- $C_0$ = universal constant

**Related Results:** `thm-quantitative-kl-bound`

---

### Observable Error from Wasserstein Distance

**Type:** Lemma
**Label:** `lem-observable-error-wasserstein`
**Source:** [20_A_quantitative_error_bounds.md § Part I](20_A_quantitative_error_bounds.md)
**Tags:** `kantorovich-rubinstein`, `observable-error`, `wasserstein`

**Statement:**
For Lipschitz observable $\phi$ with constant $L_\phi$:

$$
\left| \int \phi \, d\mu_N - \int \phi \, d\nu_0 \right| \leq L_\phi \cdot W_1(\mu_N, \nu_0) \leq L_\phi \cdot W_2(\mu_N, \nu_0)
$$

This is the Kantorovich-Rubinstein duality.

**Related Results:** `thm-quantitative-propagation-chaos`
...
**Type:** Lemma
**Label:** `lem-empirical-measure-concentration`
**Source:** [20_A_quantitative_error_bounds.md § Part I](20_A_quantitative_error_bounds.md)
**Tags:** `empirical-measure`, `concentration`, `fournier-guillin`, `variance`

**Statement:**
For the empirical measure $\hat{\mu}_N = \frac{1}{N}\sum_{i=1}^N \delta_{Z^{(i)}}$ with $Z^{(i)} \sim \nu_N^{\text{marginal}}$:

$$
\mathbb{E}\left[ W_2^2(\hat{\mu}_N, \nu_N^{\text{marginal}}) \right] \leq \frac{C_{\text{var}}}{N}
$$

where $C_{\text{var}} = \mathbb{E}_{\nu_N^{\text{marginal}}}[\|Z\|^2]$ (second moment bound).

**Related Results:** `lem-finite-second-moment`
...
**Type:** Lemma
**Label:** `lem-finite-second-moment`
**Source:** [20_A_quantitative_error_bounds.md § Part I](20_A_quantitative_error_bounds.md)
**Tags:** `second-moment`, `confinement`, `lyapunov-drift`

**Statement:**
Under confinement and Lyapunov drift conditions:

$$
C_{\text{var}} := \mathbb{E}_{\nu_N^{\text{marginal}}}[\|Z\|^2] < \infty
$$

with explicit bound:

$$
C_{\text{var}} \leq \frac{C_{\text{noise}}}{\kappa_{\text{conf}}}
$$

where $\kappa_{\text{conf}} > 0$ is the confinement rate and $C_{\text{noise}}$ bounds the noise variance.

**Related Results:** `lem-empirical-measure-concentration`
...
**Source:** [20_A_quantitative_error_bounds.md § Part I](20_A_quantitative_error_bounds.md)
**Tags:** `propagation-of-chaos`, `mean-field-error`, `convergence-rate`, `central-limit`

**Statement:**
For Lipschitz observable $\phi: \mathcal{Z} \to \mathbb{R}$ with constant $L_\phi$:
...
with $C' = 2/\alpha_{\text{LSI}}$ from Talagrand inequality.

**Related Results:** All Part I lemmas, `thm-total-error-bound`

---

### Fourth-Moment Bounds for BAOAB

**Type:** Lemma
**Label:** `lem-baoab-fourth-moment`
**Source:** [20_A_quantitative_error_bounds.md § Part II](20_A_quantitative_error_bounds.md)
**Tags:** `baoab`, `moment-bounds`, `symplectic-integrator`, `energy-preservation`

**Statement:**
Under BAOAB integrator with time step $\Delta t$:

$$
\sup_{k \geq 0} \mathbb{E}[\|X_k\|^4 + \|V_k\|^4] \leq C_4(\gamma, \beta, \kappa_{\text{conf}}, d) < \infty
$$

The constant $C_4$ is independent of $N$ and $\Delta t$ (for sufficiently small $\Delta t$).

**Related Results:** `lem-baoab-weak-error`
...
**Source:** [20_A_quantitative_error_bounds.md § Part II](20_A_quantitative_error_bounds.md)
**Tags:** `baoab`, `weak-error`, `local-error`, `order-analysis`

**Statement:**
For smooth test function $\Phi \in C^4(\Omega^N)$:

$$
\left| \mathbb{E}[\Phi(Z_{\Delta t})] - \mathbb{E}[\Phi(Z_0)] - \Delta t \cdot \mathcal{L}_{\text{Langevin}} \Phi(Z_0) \right| \leq C_{\text{BAOAB}} \|\Phi\|_{C^4} (\Delta t)^3
$$

where $C_{\text{BAOAB}}$ depends on $C_4$ (fourth-moment bound) and regularity of the potential.

**Related Results:** `lem-baoab-fourth-moment`, `lem-baoab-invariant-measure-error`
...
**Source:** [20_A_quantitative_error_bounds.md § Part II](20_A_quantitative_error_bounds.md)
**Tags:** `baoab`, `invariant-measure`, `global-error`, `poisson-equation`

**Statement:**
For the discrete-time invariant measure $\nu_N^{\text{discrete,Langevin}}$ vs continuous-time $\nu_N^{\text{cont,Langevin}}$:

$$
\left| \mathbb{E}_{\nu_N^{\text{discrete,Langevin}}} [\Phi] - \mathbb{E}_{\nu_N^{\text{cont,Langevin}}} [\Phi] \right| \leq C_{\text{poisson}} \|\Phi\|_{C^4} \Delta t
$$

where $C_{\text{poisson}} = C_{\text{BAOAB}} / \kappa_{\text{mix}}^{\text{Langevin}}$ with $\kappa_{\text{mix}}^{\text{Langevin}}$ the mixing rate.

**Related Results:** `lem-baoab-weak-error`, `thm-langevin-discretization-error`

---

### Langevin-BAOAB Discretization Error

**Type:** Theorem
**Label:** `thm-langevin-discretization-error`
**Source:** [20_A_quantitative_error_bounds.md § Part II](20_A_quantitative_error_bounds.md)
**Tags:** `langevin`, `discretization`, `convergence-rate`, `n-uniform`

**Statement:**
The discretization error for the Langevin operator is:

$$
\boxed{
\left| \mathbb{E}_{\nu_N^{\text{discrete,Langevin}}} [\Phi] - \mathbb{E}_{\nu_N^{\text{cont,Langevin}}} [\Phi] \right| \leq C_{\text{Langevin}} \|\Phi\|_{C^4} \Delta t
}
$$

where $C_{\text{Langevin}} = C_{\text{poisson}}$ is **independent of N**.

**Related Results:** `lem-baoab-invariant-measure-error`, Part III cloning discretization

---

### Lie Splitting Weak Error

**Type:** Lemma
**Label:** `lem-lie-splitting-weak-error`
**Source:** [20_A_quantitative_error_bounds.md § Part III](20_A_quantitative_error_bounds.md)
**Tags:** `lie-splitting`, `operator-splitting`, `commutator`, `weak-error`

**Statement:**
For operators $\mathcal{L}_A, \mathcal{L}_B$ with generators, the Lie-Trotter splitting error is:

$$
\left| \mathbb{E}[\Phi(Z_{\text{split}})] - \mathbb{E}[\Phi(Z_{\text{exact}})] \right| \leq \frac{1}{2} \|[\mathcal{L}_A, \mathcal{L}_B] \Phi\| (\Delta t)^2 + O((\Delta t)^3)
$$

**Related Results:** `lem-uniform-geometric-ergodicity`, `lem-commutator-n-uniform`
...
**Source:** [20_A_quantitative_error_bounds.md § Part III](20_A_quantitative_error_bounds.md)
**Tags:** `geometric-ergodicity`, `drift-minorization`, `mixing-rate`, `n-uniform`

**Statement:**
The combined operator $\mathcal{L}_{\text{total}} = \mathcal{L}_{\text{Langevin}} + \mathcal{L}_{\text{clone}}$ satisfies:

$$
\|\mu P_t - \nu_N^{\text{QSD}}\|_{\text{TV}} \leq C_{\text{geo}} e^{-\kappa_{\text{mix}}^{\text{cont}} t}
$$

where $\kappa_{\text{mix}}^{\text{cont}} > 0$ is the **N-uniform mixing rate** established via Meyn-Tweedie drift conditions.

**Related Results:** `thm-meyn-tweedie`, `lem-mixing-rate-relationship`
...
**Type:** Theorem
**Label:** `thm-meyn-tweedie`
**Source:** [20_A_quantitative_error_bounds.md § Part III](20_A_quantitative_error_bounds.md)
**Tags:** `meyn-tweedie`, `drift-condition`, `minorization`, `ergodicity`

**Statement:**
If Markov process satisfies:
1. **Drift condition**: $\mathcal{L}V \leq -\kappa V + b \mathbf{1}_C$ for Lyapunov function $V$
2. **Minorization**: On compact set $C$, $P_t(x, \cdot) \geq \delta \nu(\cdot)$ for some $t_0, \delta > 0$

Then geometric ergodicity holds with explicit rate $\kappa_{\text{mix}} = f(\kappa, \delta, t_0)$.

**Related Results:** `lem-uniform-geometric-ergodicity`

---

### Mixing Rate Relationship

**Type:** Lemma
**Label:** `lem-mixing-rate-relationship`
**Source:** [20_A_quantitative_error_bounds.md § Part III](20_A_quantitative_error_bounds.md)
**Tags:** `mixing-rate`, `spectral-gap`, `kinetic-cloning`

**Statement:**
The total mixing rate satisfies:

$$
\kappa_{\text{mix}}^{\text{cont}} \geq \min(\kappa_{\text{kin}}, f_{\text{clone}} \cdot \kappa_{\text{clone}})
$$

where:
- $\kappa_{\text{kin}}$ = kinetic operator mixing rate
- $\kappa_{\text{clone}}$ = cloning operator contraction rate
- $f_{\text{clone}}$ = cloning frequency

Both rates are **N-uniform**.

**Related Results:** `lem-uniform-geometric-ergodicity`

---

### Error Propagation via Poisson Equation

**Type:** Lemma
**Label:** `lem-error-propagation-poisson`
**Source:** [20_A_quantitative_error_bounds.md § Part III](20_A_quantitative_error_bounds.md)
**Tags:** `poisson-equation`, `error-propagation`, `global-error`, `regularity`

**Statement:**
Local weak error $\epsilon_{\text{weak}}(\Delta t)$ propagates to invariant measure error via:

$$
\left| \mathbb{E}_{\nu^{\text{discrete}}} [\Phi] - \mathbb{E}_{\nu^{\text{cont}}} [\Phi] \right| \leq \frac{\epsilon_{\text{weak}}(\Delta t)}{\kappa_{\text{mix}}}
$$

For $C^4$ observables, this requires solving Poisson equation $\mathcal{L}g = \Phi - \mathbb{E}_{\nu}[\Phi]$ with regularity:

$$
\|g\|_{C^4} \leq C_{\text{reg}} \|\Phi\|_{C^4}
$$

**Related Results:** `thm-full-system-discretization-error`

---

### Full System Discretization Error

**Type:** Theorem
**Label:** `thm-full-system-discretization-error`
**Source:** [20_A_quantitative_error_bounds.md § Part III](20_A_quantitative_error_bounds.md)
**Tags:** `discretization-error`, `total-operator`, `convergence-rate`, `n-uniform`

**Statement:**
For the fully discrete system (BAOAB + cloning with Lie splitting):

$$
\boxed{
\left| \mathbb{E}_{\nu_N^{\text{discrete}}} [\Phi] - \mathbb{E}_{\nu_N^{\text{cont}}} [\Phi] \right| \leq C_{\text{split}} \|\Phi\|_{C^4} \Delta t
}
$$
...
$$
C_{\text{split}} = \frac{C_{\text{Langevin}} + C_{\text{comm}}}{\kappa_{\text{mix}}^{\text{cont}}}
$$

with $C_{\text{comm}}$ the **N-uniform commutator bound**.

**Related Results:** `thm-langevin-discretization-error`, `lem-error-propagation-poisson`
...
**Source:** [20_A_quantitative_error_bounds.md § Part IV](20_A_quantitative_error_bounds.md)
**Tags:** `total-error`, `convergence-rate`, `optimal-rate`, `main-result`

**Statement:**
For smooth observable $\phi \in C^4(\mathcal{Z})$, the total error between discrete N-particle system and continuous mean-field limit is:
...
**Assumptions:**
1. N-uniform LSI with constant $\alpha_{\text{LSI}}$
2. Geometric ergodicity with mixing rate $\kappa_{\text{mix}}^{\text{cont}}$
3. $C^4$ regularity
4. Confinement potential

**Related Results:** `thm-quantitative-propagation-chaos`, `thm-full-system-discretization-error`

---

### Explicit Constants in Total Error Bound

**Type:** Definition
**Label:** `def-explicit-error-constants`
**Source:** [20_A_quantitative_error_bounds.md § Part IV](20_A_quantitative_error_bounds.md)
**Tags:** `constants`, `explicit-formula`, `mean-field-constant`, `discretization-constant`
...
where $C' = 2/\alpha_{\text{LSI}}$ and:
- $C_{\text{var}} = \mathbb{E}[\|Z\|^2] \leq C_{\text{noise}}/\kappa_{\text{conf}}$
- $C_{\text{int}} \leq C_0(L_b^2 + L_{\sigma}^2 + L_b^2/\alpha_{\text{LSI}})$
...
where:
- $C_{\text{split}} = (C_{\text{Langevin}} + C_{\text{comm}})/\kappa_{\text{mix}}^{\text{cont}}$
- $C_{\text{poisson}}$ from BAOAB Poisson regularity
- $C_{\text{comm}}$ is N-uniform commutator bound

**Related Results:** `thm-total-error-bound`

---

### Rate Interpretation and Optimality

**Type:** Remark
**Label:** `rem-rate-interpretation`
**Source:** [20_A_quantitative_error_bounds.md § Part IV](20_A_quantitative_error_bounds.md)
**Tags:** `convergence-rate`, `optimal-rate`, `negligible-terms`, `interpretation`

**Statement:**
The total error decomposes as:

$$
\text{Total Error} = \underbrace{\frac{C_{\text{MF}}}{\sqrt{N}}}_{\text{Mean-field: dominant}} + \underbrace{\frac{C_{\text{discrete}} \Delta t}{N}}_{\text{Discretization: negligible}}
$$

**Key observations:**
1. Mean-field error O(1/√N) is **optimal** (Central Limit Theorem)
2. Discretization error O(Δt/N) is **negligible** for any practical N and Δt
3. For fixed Δt, error is O(1/√N) as N → ∞
4. For fixed N, error is O(Δt/N) as Δt → 0
5. All constants are **independent of N and Δt**
...
**Source:** [20_A_quantitative_error_bounds.md § Part IV](20_A_quantitative_error_bounds.md)
**Tags:** `strang-splitting`, `higher-order`, `optimization`, `practical-implementation`

**Statement:**
**Strang splitting** (symmetric second-order):

$$
\Psi_{\Delta t} = e^{\frac{\Delta t}{2}\mathcal{L}_{\text{Langevin}}} \circ e^{\Delta t \mathcal{L}_{\text{clone}}} \circ e^{\frac{\Delta t}{2}\mathcal{L}_{\text{Langevin}}}
$$

achieves:
- Local weak error: O((Δt)³)
- Global error: O((Δt)²) for invariant measure

**But**: Still divided by N for empirical observable, giving O((Δt)²/N), still negligible.
