...
**Relationship to other proofs**:
- **Alternative to**: Displacement convexity proof (Section 5.2 of [09_kl_convergence](09_kl_convergence))
...
**Remark**: This is a condensed version of the full hypocoercivity argument. The complete proof with explicit matrix calculations is in Section 2-3 of [09_kl_convergence](09_kl_convergence).
