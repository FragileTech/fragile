...
1. Validation that proofs match theorem claims
2. Automatic relationship extraction from proofs
...
def attach_proof_to_theorem(
    ...
    if proof.all_steps_expanded():
        ...
        from fragile.proofs.core.proof_system import ProofStepStatus
