...
class RegistryPipelineOrchestrator:
    ...
    def transform_refined_to_pipeline(self, chapter: str, document: str) -> bool:
        ...
        cmd = [
            sys.executable,
            "-m",
            "fragile.proofs.tools.enriched_to_math_types",
            "--input",
            str(input_path),
            "--output",
            str(output_path),
    ...
    def build_refined_registry(self, chapter: str, document: str) -> bool:
        ...
        cmd = [
            sys.executable,
            "-m",
            "fragile.proofs.tools.build_refined_registry",
            "--docs-root",
    ...
    def build_pipeline_registry(self, chapter: str, document: str) -> bool:
        ...
        cmd = [
            sys.executable,
            "-m",
            "fragile.proofs.tools.build_pipeline_registry",
            "--pipeline-dir",
            str(input_path),
            "--output",
            str(output_path),
    ...
    def aggregate_combined_registries(self):
        ...
        cmd = [
            sys.executable,
            "-m",
            "fragile.proofs.tools.aggregate_registries",
            "--type",
            "refined",
            "--per-document-root",
