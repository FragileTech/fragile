...
from fragile.proofs.core.pipeline_types import MathematicalObject, ObjectType, Attribute, AttributeEvent
...
from fragile.proofs.sympy.expressions import AssumptionSet
...
class PropertyWithSymPy(Attribute):
    ...
    dual_expression: Optional[DualExpr] = Field(
        None,
...
class MathematicalObjectWithSymPy(MathematicalObject):
    ...
    def add_property_with_sympy(
        ...
        from fragile.proofs.core.pipeline_types import AttributeEvent, AttributeEventType
...
def create_property_with_dual_expr(
    ...
    object_label: str,
    established_by: str,
    dual_expr: Optional[DualExpr] = None,
