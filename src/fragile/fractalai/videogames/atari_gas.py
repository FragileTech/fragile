...
from fragile.fractalai.fractal_gas import FractalGas, WalkerState  # noqa: F401 (re-export)


class AtariFractalGas(FractalGas):
    ...
    def run_with_tree(
        ...
        Args:
            ...
            game_name: Backward-compatible alias for *task_label*.
        ...
        return super().run_with_tree(
            ...
            task_label=game_name or task_label,
