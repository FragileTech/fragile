...
This package provides testing infrastructure for validating gauge-theory
interpretations of the Fragile Gas algorithm's symmetry structure.

**Purpose:**
Test whether the symmetry structure (U(1) fitness phases, SU(2) cloning-score phases,
and SU(N) viscous-force complexification) supports local gauge theory interpretation
or operates in mean-field regime.
...
- `u1_symmetry`: U(1)_fitness symmetry tests (fitness phases)
- `su2_symmetry`: SU(2)_weak symmetry tests (cloning-score phases)
...
1. **Unified Definitions**: U(1) phases from fitness; SU(2) phases from cloning scores
...
experiment that determines whether the structure supports local gauge theory:
