...
def compute_cloning_probability(
    ...
    Args:
        ...
        p_max: Maximum cloning probability threshold (default: 1.)
...
def clone_walkers(
    ...
    **clone_tensor_kwargs,
    ...
    """Execute complete cloning operator Ψ_clone. All walkers assumed alive.
...
class CloneOperator(PanelModel):
    ...
    Example:
        ...
        >>> pos_new, vel_new, other_cloned, info = operator(positions, velocities, fitness, companions)
    """
    ...
    def __call__(
        ...
        **clone_tensor_kwargs,
        ...
        """Execute cloning operator. All walkers assumed alive.
        ...
        Returns:
            positions_new: Updated positions [N, d]
            velocities_new: Updated velocities [N, d]
            cloned_tensors: Dictionary of cloned additional tensors.
            info: Dictionary with intermediate results.
        """
