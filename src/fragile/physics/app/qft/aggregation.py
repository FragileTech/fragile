...
Usage:
    from fragile.physics.app.qft.aggregation import (
...
from fragile.physics.app.qft.neighbor_analysis import (
...
if TYPE_CHECKING:
    ...
    from fragile.physics.app.qft.correlator_channels import ChannelConfig
...
def aggregate_time_series(
    ...
    Neighbor Method Selection:
        Neighbor topology is computed by fragile.physics.app.qft.neighbor_analysis.
