...
def _compute_tensor_traceless_snapshot_operator(
    ...
    bounds = None  # PBC no longer stored on RunHistory
    ...
    if bounds is not None:  # PBC no longer stored on RunHistory
...
def create_app() -> pn.template.FastListTemplate:
    ...
    def _build_ui():
        ...
        gas_config = GasConfigPanel.create_qft_config(bounds_extent=2.0)
