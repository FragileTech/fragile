...
class LangevinMulti(Scene):
    def construct(self):
        ...
        legend_items = VGroup(
            VGroup(Dot(color=YELLOW, radius=0.08), Text("Particles", font_size=18)).arrange(RIGHT, buff=0.2),
            VGroup(Line(ORIGIN, RIGHT*0.3, color=BLUE_C, stroke_width=2), Text("Trajectories", font_size=18)).arrange(RIGHT, buff=0.2),
        ...
        colors = [YELLOW, RED, GREEN, BLUE, ORANGE, PURPLE, PINK, TEAL, 
                 LIGHT_BROWN, MAROON, GOLD, LIGHT_PINK, GREY, WHITE]
