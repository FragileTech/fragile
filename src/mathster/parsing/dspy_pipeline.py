...
Architecture:
    process_document()
      ...
      │     ├─> If NEW: extract_workflow.extract_chapter()
...
Example:
    # Fresh extraction (creates chapter_*.json files)
...
def process_document(
    ...
    Args:
        ...
        model: DSPy model identifier (default: claude-haiku-4-5)
