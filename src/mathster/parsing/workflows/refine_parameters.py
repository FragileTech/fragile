...
def refine_parameter_line_numbers(
    ...
    """
    from mathster.parsing.dspy_components.parameter_line_finder import ParameterLineFinder
    from mathster.parsing.text_processing.analysis import _get_symbol_variants
