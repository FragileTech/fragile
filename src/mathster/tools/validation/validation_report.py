    ...
    def _generate_recommendations(self) -> list[str]:
        ...
        if self.result.is_valid:
            lines.extend((
                ...
                "",
                "**Next Steps:**",
                "1. Run transformation: `python -m fragile.mathster.tools.enriched_to_math_types`",
            ...
            lines.extend((
                ...
                f"python -m fragile.mathster.tools.find_incomplete_entities \\\n"
                f"  --refined-dir {self.refined_dir}",
                "",
                "# Complete partial refinements",
                f"python -m fragile.mathster.tools.complete_refinement \\\n"
                f"  --refined-dir {self.refined_dir}",
                "```",
            ))
