...
Usage (CLI):
    python -m fragile.mathster.reports.remark_report \
        --input path/to/remark-*.json \
        --output path/to/remark-*.md

Programmatic:
    from fragile.mathster.reports.remark_report import remark_to_markdown
...
from mathster.core.enriched_types import RemarkBox, RemarkType
