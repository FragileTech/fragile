...
Usage (CLI):
    python -m fragile.mathster.reports.equation_report \
        --input path/to/eq-langevin.json \
        --output path/to/eq-langevin.md

Programmatic:
    from fragile.mathster.reports.equation_report import equation_to_markdown
...
from mathster.core.enriched_types import EquationBox
