...
from mathster.sympy_integration.expressions import AssumptionSet
...
class MathematicalObjectWithSymPy(MathematicalObject):
    ...
    def create_sympy_context(self) -> SymPyContext:
        ...
        This is useful for validating mathster involving this object.
        """
    ...
    def add_property_with_sympy(
        ...
        from mathster.core.pipeline_types import AttributeEventType
...
def create_property_with_dual_expr(
    ...
    **kwargs,
    ...
    Example:
        >>> from fragile.mathster import create_dual_expr_from_latex
...
def merge_symbol_tables(
    ...
    Useful for creating a unified SymPy context for mathster involving
    multiple objects.
...
def create_combined_sympy_context(
    ...
    mathster that involve multiple objects.
